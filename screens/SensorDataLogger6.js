...
const appendSensorDataToLogs6 = async () => {
  try {
    const storedLogs = await getItem('sensorLogs6');
    ...
    await setItem('sensorLogs6', JSON.stringify(updatedLogsWithNewLog));
...
const startDataLogging6 = () => {
  setInterval(() => {
    appendSensorDataToLogs6();
  }, 120000); // Run every 2 minutes
};

export { startDataLogging6, appendSensorDataToLogs6};
