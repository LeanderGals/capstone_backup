...
const appendSensorDataToLogs9 = async () => {
  try {
    const storedLogs = await getItem('sensorLogs9');
    ...
    await setItem('sensorLogs9', JSON.stringify(updatedLogsWithNewLog));
...
const startDataLogging9 = () => {
  setInterval(() => {
    appendSensorDataToLogs9();
  }, 120000); // Run every 2 minutes
};

export { startDataLogging9, appendSensorDataToLogs9 };
