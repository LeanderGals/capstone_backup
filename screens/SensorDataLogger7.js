...
const appendSensorDataToLogs7 = async () => {
  try {
    const storedLogs = await getItem('sensorLogs7');
    ...
    await setItem('sensorLogs7', JSON.stringify(updatedLogsWithNewLog));
...
const startDataLogging7 = () => {
  setInterval(() => {
    appendSensorDataToLogs7();
  }, 120000); // Run every 2 minutes
};

export { startDataLogging7, appendSensorDataToLogs7 };
