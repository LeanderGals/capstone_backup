...
const appendSensorDataToLogs10 = async () => {
  try {
    const storedLogs = await getItem('sensorLogs10');
    ...
    await setItem('sensorLogs10', JSON.stringify(updatedLogsWithNewLog));
...
const startDataLogging10 = () => {
  setInterval(() => {
    appendSensorDataToLogs10();
  }, 120000); // Run every 2 minutes
};

export { startDataLogging10, appendSensorDataToLogs10 };
